...
import com.mybank.ebankingbackend.mappers.BankAccountMapperImpl;
...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, double overDraft, Long customerId) throws CustomerNotFoundException {
        log.info("save Current Bank Account");
    ...
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, Long customerId) throws CustomerNotFoundException {
        log.info("save Saving Bank Account");
        Customer customer = customerRepository.findById(customerId).orElse(null);
        if (customer == null)
            throw new CustomerNotFoundException("Customer not found");
    ...
    @Override
    public List<BankAccountDTO> customerBankAccounts( String id) throws BankAccountNotFoundException {
        List<BankAccount> bankAccounts = bankAccountRepository.findBankAccountByCustomerId(id);
        List<BankAccountDTO> bankAccountDTOS = bankAccounts.stream().map(bankAccount -> {
            if (bankAccount instanceof SavingAccount) {
                SavingAccount savingAccount = (SavingAccount) bankAccount;
                return dtoMapper.fromSavingBankAccount(savingAccount);
    ...
    @Override
    public CustomerDTO login(String email) throws CustomerNotFoundException {
